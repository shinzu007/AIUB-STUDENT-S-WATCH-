/* Faculty,student,Admin information
 * are shown here
 */
package demo1;
...
class InformationForAdmin extends JFrame implements ActionListener {
		...
		public InformationForAdmin(User u,User m)
		    { 
			this.u=u;
			this.m=m;
			...
			for(int i=10;i<=19;i++){
				...
				l[19].setBounds(85+120+10,50+30+50+30+10+40+40+40+40+40+40+10+40,300,35);
